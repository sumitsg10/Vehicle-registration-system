...
$insu=$_POST['insu'];
$rmk=$_POST['rmk'];
$sql="INSERT INTO  tbl2wheeler(PermitNumber,VehicleType,EmpCd,EmpName,RegsNo,ModelNo,Colour,MobileNo,EmailId,GatePassValidFrom,GatePassValidUpto,DLNo,DLUpto,InsuranceNo,InsuranceUpto,Remarks) VALUES(:pernum,:vtype,:empcd,:empname,:regnum,:modnum,:clr,:mobnum,:mailid,:gvf,:gvu,:dlnum,:dlu,:insnum,:insu,:rmk)";
...
if($lastInsertId)
{
$_SESSION['msg']="2 Wheeler Listed successfully";
header('location:managetwowheelers.php');
}
else 
{
...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Add 2 Wheeler</h4>
