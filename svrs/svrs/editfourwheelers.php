...
$insu=$_POST['insu'];
$rmk=$_POST['rmk'];
$sql="update  tbl4wheeler set PermitNumber=:pernum, VehicleType=:vtype, EmpCd=:empcd, EmpName=:empname, RegsNo=:regnum, ModelNo=:modnum, Colour=:clr, MobileNo=:mobnum, EmailId=:mailid, GatePassValidFrom=:gvf, GatePassValidUpto=:gvu, DLNo=:dlnum, DLUpto=:dlu, InsuranceNo=:insnum, InsuranceUpto=:insu, Remarks=:rmk where id=:twoid";
...
header('location:managefourwheelers.php');
}
?>
<!DOCTYPE html>
