...
<head>
    ...
    <title>Vehicle Registration System | Manage 2 Wheelers</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Expired 2 Wheelers</h4>
    </div>
     <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           Exprire Gate Pass Two Wheelers List
                        </div>
...
$sql = "SELECT * from  tbl2wheeler where date(GatePassValidUpto)='$currentDate'  or date(GatePassValidUpto)<'$currentDate'";
$query = $dbh -> prepare($sql);
$query->execute();
...
{ 
 ...
 ?>                                      
		...
		<td class="center"><?php echo htmlentities($result->GatePassValidFrom);?></td>
									...
									<td class="center"><?php echo htmlentities($result->GatePassValidUpto);?></td>
									...
									<td class="center"><?php echo htmlentities($result->DLNo);?></td>
                                            ...
                                            <!---<a href="edit-2wheelers.php?twoid=<//?php echo htmlentities($result->id);?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Edit</button> 
                                          <a href="manage-2wheelers.php?del=</?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to delete?');"" >  <button class="btn btn-danger"><i class="fa fa-pencil"></i> Delete</button>-->
                                            </td>
                                        </tr>
 <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
