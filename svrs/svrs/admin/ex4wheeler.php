...
{
$id=$_GET['del'];
$sql = "delete from tbl4wheeler  WHERE id=:id";
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Expired 4 Wheelers</h4>
    </div>
     <div class="row">
...
$sql = "SELECT * from  tbl4wheeler where date(GatePassValidUpto)='$currentDate'  or date(GatePassValidUpto)<'$currentDate'";
$query = $dbh -> prepare($sql);
$query->execute();
